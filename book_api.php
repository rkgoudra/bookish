...
switch($flag){
    ...
    $user_id=$_POST['uid'];
         $sql="INSERT INTO `book_table`(`title`, `image`, `author_name`, `language`, `gener`, `status`, `description`,`user_id`) 
         VALUES ('$book_title','$book_image','$book_auth_name','$book_language','$book_gener','$book_status','$book_description','$user_id') ";
